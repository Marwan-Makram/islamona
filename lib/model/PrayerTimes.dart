...
//
//     final azkarApp = azkarAppFromJson(jsonString);

import 'dart:convert';

AzkarApp azkarAppFromJson(String str) => AzkarApp.fromJson(json.decode(str));

String azkarAppToJson(AzkarApp data) => json.encode(data.toJson());
...
class AzkarApp {
  ...
  factory AzkarApp.fromJson(Map<String, dynamic> json) => AzkarApp(
    code: json["code"],
    status: json["status"],
